                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="task_add.php">Add New Task</a></li>
                        ...
                        foreach ($tasks as $task){
                           ...
                           echo '</td>
                            <td class="project-actions text-right">
                                ...
                                <a class="btn btn-danger btn-sm" href="deleteTask.php?id='.$task['id_'].'">
